...
assert manifest["semantic_version"] in {"FC-1-v1.1+phase2", "FC-1-v1.1+phase3", "FC-1-v1.1+phase4"}
...
assert any(version in project for version in ('version = "0.3.0.dev1"', 'version = "0.4.0.dev1"', 'version = "0.5.0.dev1"'))
