#!/usr/bin/env python3
"""Build deterministic WP1 post-merge closeout SHA-256 ledger."""
...
VERIFY = ROOT / "scripts/verify_gate3_cluster_b_wp1_post_merge_closeout.py"
...
def load_verifier():
    spec = importlib.util.spec_from_file_location("wp1_post_merge_verify", VERIFY)
