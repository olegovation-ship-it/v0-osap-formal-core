...
assert manifest["semantic_version"] in {"FC-1-v1.1+phase3", "FC-1-v1.1+phase4", "FC-1-v1.1+phase5", "FC-1-v1.1+phase6"}
assert manifest["status"] in {"PHASE3_T133_T138_PATCH_ORACLE_SET", "PHASE4_T139_T144_PATCH_ORACLE_SET", "PHASE5_T145_T150_PATCH_ORACLE_SET", "PHASE6_T151_T156_EXTENSION_PATCH_ORACLE_SET"}
...
assert any(version in (ROOT/"pyproject.toml").read_text(encoding="utf-8") for version in ('version = "0.4.0.dev1"', 'version = "0.5.0.dev1"', 'version = "0.6.0.dev1"', 'version = "0.7.0.dev1"'))
assert any(version in semantic for version in ('"implementation_version": "v0-osap-fc1/0.4.0.dev1"', '"implementation_version": "v0-osap-fc1/0.5.0.dev1"', '"implementation_version": "v0-osap-fc1/0.6.0.dev1"', '"implementation_version": "v0-osap-fc1/0.7.0.dev1"'))
